...
import com.mincom.enterpriseservice.ellipse.timesheetallows.TimesheetAllowsServiceModifyReplyCollectionDTO
import com.mincom.enterpriseservice.ellipse.timesheetallows.TimesheetAllowsServiceModifyReplyDTO
...
class TimesheetAllowsService_multipleModify extends ServiceHook {
    ...
    /**
     * Save the Allowance WO from TimesheetAllowsServiceModifyReplyCollectionDTO
     * using the correct pay group from the employee.
     * @param result TimesheetAllowsServiceModifyReplyCollectionDTO
     */
    private void storeTimesheetAllowsPayGroup(Object result) {
        log.info("storeTimesheetAllowsPayGroup")
        TimesheetAllowsServiceModifyReplyCollectionDTO coll = (TimesheetAllowsServiceModifyReplyCollectionDTO) result
        coll.getReplyElements().each {TimesheetAllowsServiceModifyReplyDTO request ->
