 ...
 *
 * Post-Create:
 * When a call out Work Order is completed, send an email notification to the
 * Work Group Team Leader by requesting TRBWOE.
 *
 */
...
public class WorkOrderService_complete extends ServiceHook {
 ...
 public Object onPostExecute(Object input, Object result) {
     log.info("WorkOrderService_complete onPostExecute - version: ${version}")
     
     WorkOrderServiceCompleteReplyDTO reply = result
     
     try {
         // Get WO details - some information are not available in the WorkOrderServiceCompleteReplyDTO
